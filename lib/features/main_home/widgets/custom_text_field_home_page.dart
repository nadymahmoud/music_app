  ...
  Widget build(BuildContext context) {
    return TextField(
      decoration: InputDecoration(
          ...
          hintStyle: TextStyle(color: ColorManager.kWhiteColor, fontSize: FontSizeManager.f12),
          filled: true,
          fillColor:  ColorManager.kLightWhiteColor,
          enabledBorder:
              OutlineInputBorder(borderRadius: BorderRadius.circular(RadiusValueManager.r50)),
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(RadiusValueManager.r50))),
    );
  }
}
